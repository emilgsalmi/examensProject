            ...
            <div className="about-page1">
                <div className="about-wrapper">
                    <div className="about-inner-wrapper">
                        <h1>om oss</h1>
                        <p>Välkommen till Emils Gitarr Butik – ditt hem för passionerade gitarrister och musikälskare i hjärtat av Stockholm. <br /> Sedan vår öppning år 2023 har vi försett musikentusiaster med kvalitativa gitarrer och tillbehör, och vår dedikation till att erbjuda den bästa musikupplevelsen har gjort oss till en av stadens främsta gitarrdestinationer.
